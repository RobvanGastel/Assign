<template>
  <section class="post">
    ...
    <div class="profile" :style="{ 'background-image': 'url(' + 'api/img/' + this.post.user.profileImage + ')' }" ></div>
  ...
  metaInfo () {
    return {
      ...
      meta: [
        ...
        { property: 'og:image', content: 'assign/resources/share-image.jpg' },
        ...
        { name: 'twitter:image', content: 'assign/resources/share-image.jpg' },
      ...
      link: [
        { rel: 'shortcut icon', href: 'assign/resources/favicon.png' }
      ]
    }
  }
}
