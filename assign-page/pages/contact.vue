  ...
  head () {
    return {
      ...
      meta: [
        ...
        { name: 'description', content: 'Wij beantwoorden graag jouw vragen, je kunt op verschillende manieren met ons in contact komen.' },
        { property: 'og:title', content: 'Assign – Contact' },
        { property: 'og:site_name', content: 'assignapp.nl' },
        { property: 'og:description', content: 'Wij beantwoorden graag jouw vragen, je kunt op verschillende manieren met ons in contact komen.' },
        ...
        { name: 'twitter:title', content: 'Assign – Contact' },
        { name: 'twitter:site_name', content: 'Assign – Contact' },
        { name: 'twitter:description', content: 'Wij beantwoorden graag jouw vragen, je kunt op verschillende manieren met ons in contact komen.' },
